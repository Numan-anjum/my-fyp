...
if($usertype != "admin")
{
  header("Location: ../login.php");
    ...
    $coderID = $_GET['coderID']; //from codercompleteprofile.php
    
    $query = " SELECT * FROM coderprofiles WHERE CoderID='".$coderID."'";
                ...
                <div class="col-lg-12 m-auto">
                    <div class="card mt-1">
                        <div class="card-title">
                            <h4 class="bg-dark text-white text-center py-3"> Update Coder's Profile
                            </h4>
                        </div>
                        <div class="card-body">

                            <form action="updatecoders.php?CoderID=<?php echo $coderID ?>" enctype="multipart/form-data" method="post">
...
<br><br><br>
                                ...
                                <img src="../coder/uploads/<?php echo $image;?>" style="width:150px;height:150">




                                <br><b><div align="center"><button class="btn btn-primary btn-lg" name="update">Update</button></div>
