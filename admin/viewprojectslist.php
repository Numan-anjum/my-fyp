                ...
                <div class="col-lg-12 m-auto">
                    <div class="card mt-2">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            ?>
                                    <tr>
                                        <td><a href="viewcompleteprojects.php?projectID=<?php echo $projectID; ?>"><?php echo $projectID; ?></a></td>
                                        <td><?php echo $proj_name; ?></td>
                                        <td><?php echo $proj_type; ?></td>
                                        <td><?php echo $proj_languages; ?></td>
                                        <td><?php echo $proj_budget; ?></td>

                                        <td><a href="editprojects.php?projectID=<?php echo $projectID; ?>"class = 'btn btn-primary'>Edit</a></td>
                                        

                                        <td><a onClick="return confirm('Are you sure you want to delete?')" href='deleteprojects.php?projectID=<?php echo $projectID; ?>' type='button' class='btn btn-danger'>Delete</a></td>
                                    </tr>        
                           <?php 
